...
EOF
  ...
  set_cfg "$cfg" "CONFIG_SYSLOGD" "y"
  set_cfg "$cfg" "CONFIG_FEATURE_SYSLOGD_DUP" "y"
  set_cfg "$cfg" "CONFIG_FEATURE_SYSLOGD_CFG" "y"
  set_cfg "$cfg" "CONFIG_FEATURE_SYSLOGD_READ_BUFFER_SIZE" "256"
  set_cfg "$cfg" "CONFIG_LOGREAD" "y"
  set_cfg "$cfg" "CONFIG_LOGGER" "y"
  set_cfg "$cfg" "CONFIG_FEATURE_IPC_SYSLOG" "y"
  set_cfg "$cfg" "CONFIG_FEATURE_IPC_SYSLOG_BUFFER_SIZE" "16"
